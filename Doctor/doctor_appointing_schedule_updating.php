...
<title>doctor_visiting_schedule_updating</title>
</head>
...
?><form class=" text-center text-drak text-xl-info font-weight-bold" action = "doctor_visiting_schedule_updating.php" method="POST">
