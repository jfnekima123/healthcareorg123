...
<head><title>organization medical service</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>e-healthcare org</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#location"> Location  <span class="caret"></span></a>
          <ul class="dropdown-menu"> 
    ...
    <li>  <a href='dentist.php'>Dentist</a></li>
     ...
     <li>  <a href='gynecologist.php'>Gynecologist</a></li>
        ...
        <li><a href="disease_prediction.php">Medical Service</a></li>
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">e-Healthcare org</h3>
